...
<?php get_header(); ?>
    ...
    <section id="home" class="home">
        <div class="home_content">
           ...
           <ul>
               <li> <h3>Marketing, technical, and legal documentation</h3> </li>
               <li> <h3>From English into Ukrainian</h3></li>
               <li> <h3>For 8+ years</h3> </li>
           </ul>
           <div class="button">
    ...
    <section id='information' class="information">
        ...
        <div class="information_services">
            ...
            <div class="information_services-item">
                ...
                <p>I act as your first customer in Ukrainian (advising on cultural and business issues in the source text).</p>
            </div>
            <div class="information_services-item">
        ...
        <div id="blogHome_footer" class="blog">
            ...
            ?>
                    ...
                    <div class="blog_item">
                        ...
                        <a href="<?php the_permalink(); ?>"><h3 class="h3"><?php the_title();  ?></h3></a>
