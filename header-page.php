...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-PSDC9L9');
    </script>
...
<body>
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PSDC9L9" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <header class="header">
